...
Route::prefix('v1')->group(function(){ //Version 1 of my Rest API
	...
	Route::get('dashboard', 'API\v1\Election\ResultController@OngoingResult');
	...
	Route::middleware(['auth:api', 'admin', 'election'])->group(function(){
		...
		Route::prefix('nominee')->group(function(){
			...
			Route::post('import-voters', 'API\v1\Nominee\NomineeImportController@import');
			Route::post('load-voters', 'API\v1\Nominee\NomineeImportController@loadData');			
		});
		...
		Route::prefix('voter')->group(function(){
			...
			Route::post('import-voters', 'API\v1\Voter\VoterImportController@import');
			Route::post('load-voters', 'API\v1\Voter\VoterImportController@loadData');
		});
