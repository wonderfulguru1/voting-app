			...
			<nav class="navbar navbar-default navbar-fixed-top" id="nav">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a class="navbar-brand" :href="data.baseURL"><img src="/images/logo.png" /></a>
					</div>
					<div class="collapse navbar-collapse" id="myNavbar">
						...
						<ul class="nav navbar-nav">
							...
							<router-link :to="{ name: 'Vote' }" v-if="data.election.status == 2 && !hasVoted()" tag="li"
								exact>
								<a href="#">Vote</a>
							</router-link>

							<router-link :to="{ name: 'Result' }" v-if="data.election.status == 2 && hasVoted()"
								tag="li">
								<a href="#">Results</a>
							</router-link>
