	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="form-group">
				<button class="btn btn-success" v-if="data.election.status == 1"
					@click="util.showModal('#start-election')">Start Election</button>
				...
				<button class="btn btn-danger" v-if="data.election.status == 2"
					@click="util.showModal('#stop-election')">End Election</button>
			...
			<modal id="stop-election">
				<form @submit.prevent="stop" id="stop_form">
					<div class="form-group">
						<label for="name">Election Name</label>
						<input type="text" name="name" :value="data.election.name" class="form-control"
