<template>
	<div class="panel panel-default">
		<div class="panel-body">
			<form method="POST" class="row" id="edit_form" :action="data.API + 'nominee/' + id"
				enctype="multipart/form-data" @submit.prevent="edit()">
				...
				<div class="col-md-8">
					...
					<div class="form-group">
						<label for="student_id">Member ID</label>
						<input type="text" name="student_id" class="form-control" :value="nominee.student_id"
							required />
					</div>
					...
					<div class="form-group">
						...
						<input type="text" name="motto" class="form-control" :value="nominee.motto"
					...
					<div class="form-group">
						...
						<textarea name="description" class="form-control"
							placeholder="(Optional)">{{ nominee.description }}</textarea>
					</div>
					...
					<div class="form-group">
						...
						<select class="form-control" name="partylist_id" :value="nominee.partylist_id">
							...
							<option v-for="partylist in data.partylists" :value="partylist.id">{{ partylist.name }}
							</option>
						</select>
					</div>
					...
					<div class="form-group pull-right">
						...
						<router-link :to="{ name: 'Manage Nominee' }" class="btn btn-default">
							Back
						</router-link>
					</div>
				</div>
...
<script>
import uploader from '../../../mycomponents/uploader.vue';
